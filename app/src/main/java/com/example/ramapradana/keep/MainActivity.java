...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
                ...
                call.enqueue(new Callback<LoginApiResponse>() {
                    ...
                    public void onResponse(Call<LoginApiResponse> call, Response<LoginApiResponse> response) {
                        ...
                        if (!response.body().isStatus()){
                            ...
                            Toast.makeText(MainActivity.this, "Hello " + response.body().getUser_name()+", is there anything we can save for you?", Toast.LENGTH_LONG).show();
                        }
                    }
                    ...
                    public void onFailure(Call<LoginApiResponse> call, Throwable t) {
                        progressDialog.hide();
                        Toast.makeText(MainActivity.this, "Ops.. Something went wrong with your internet connection", Toast.LENGTH_LONG).show();
                    }
                });
            }else{
                Toast.makeText(MainActivity.this, "Hello, You are still login!", Toast.LENGTH_LONG).show();
        ...
        tvSignUp.setOnClickListener(v -> SignUpActivity.start(MainActivity.this));
